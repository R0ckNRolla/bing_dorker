...
def search(ii):
	...
	if platform.system() == 'Windows':
		...
		print ('\033[31m~\033[0m' * int(sizex))
	if platform.system() == 'Windows':
		user = input('Do you want to save the results? > ')
	elif platform.system() == 'Linux' or platform.system() == 'Darwin':
		user = input('\033[32mDo you want to save the results? \033[31m> \033[97m')
	if user == 'y' or user == 'Y' or user == 'yes' or user == 'Yes' or user == 'YES':
		if platform.system() == 'Windows':
			filename = input('Filename > ')
		elif platform.system() == 'Linux' or platform.system() == 'Darwin':
			filename = input('\033[32mFilename \033[31m> \033[97m')
		if '.txt' in filename:
			filename = filename
...
if __name__ == '__main__':
	...
	if platform.system() == 'Windows':
		...
		param1 = input('\033[32mDork \033[97m> ')
	main()
